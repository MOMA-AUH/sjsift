...
The versioned sjsift catalog containing six known EGFR variants together with `METx14del` and `ARv7`. It remains an explicit input rather than a hidden application default.
...
**METx14del**:
The project identifier for MET exon 14 skipping, defined by the exon 13-to-exon 15 junction. The name does not imply that exon 14 is deleted from genomic DNA.
