...
- [`definitions/grch38.toml`](../definitions/grch38.toml) contains exactly the six supported EGFR variants, `METex14`, and `ARv7` with the specified coordinates and strand.
